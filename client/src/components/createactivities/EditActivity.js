...
class EditActivity extends Component {
  ...
  submitData = () => {
    ...
    return axios.put(`/api/activities/${this.props.theActivity._id}`, { name, description, url, minDuration, creator, categories, startTime, endTime, cost, isHighPriority, seasonStart, seasonEnd })
